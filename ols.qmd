...
$(y_i, \mathbf{x_i})$ follows a linear relationship,
...
To estimate the parameter $\mathbf{\beta}$ from sample data, OLS seeks
to minimize the squared residuals
...
$\mathbb{E}(\epsilon_i|\mathbf{x_j})=0$ and
